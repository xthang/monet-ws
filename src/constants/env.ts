...
assert(JWT_PUBLIC_KEY, 'JWT_PUBLIC_KEY')
...
export const FREE_PLAN_MAX_GROUP_MEMBERS = parseInt(process.env.FREE_PLAN_MAX_GROUP_MEMBERS!)
assert(!isNaN(FREE_PLAN_MAX_GROUP_MEMBERS), 'FREE_PLAN_MAX_GROUP_MEMBERS')
